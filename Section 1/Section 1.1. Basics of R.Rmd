...
2.  Generate a diagonal matrix `m` with dimensions `5x5`, with the diagonal equaling all multiples of 5 between 5 and 25.
    1.  What is the total length of `m`?
    2.  Name the columns `C1` through `C5` and the rows `R1` through `R5`
    3.  What is the element contained in the position (`R3`, `C3`)? Show all different methods of obtaining the answer.
3.  Create a list containing `v` and `m`.
    1.  Name the list elements (`1`, `2`).
